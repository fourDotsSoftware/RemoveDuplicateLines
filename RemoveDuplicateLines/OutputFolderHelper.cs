    ...
    class OutputFolderHelper
    {
        public static void SaveOutputFolder(string folder)
        {
            ...
            */
            ...
            int cmbc=frmBatch.Instance.cmbOutputDir.Items.Count;
            for (int k = 5; k < cmbc; k++)
            {
                frmBatch.Instance.cmbOutputDir.Items.RemoveAt(5);
            }

            for (int k = 0; k < 5 && k<lst.Count; k++)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(5 + k, lst[k]);
            ...
            frmBatch.Instance.cmbOutputDir.SelectedIndex = 5;
        }
        ...
        public static void LoadOutputFolders()
        {
            ...
            if (Properties.Settings.Default.OutputFolder1 != string.Empty)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(k++,Properties.Settings.Default.OutputFolder1);
            }

            if (Properties.Settings.Default.OutputFolder2 != string.Empty)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(k++, Properties.Settings.Default.OutputFolder2);
            }

            if (Properties.Settings.Default.OutputFolder3 != string.Empty)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(k++, Properties.Settings.Default.OutputFolder3);
            }

            if (Properties.Settings.Default.OutputFolder4 != string.Empty)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(k++, Properties.Settings.Default.OutputFolder4);
            }

            if (Properties.Settings.Default.OutputFolder5 != string.Empty)
            {
                frmBatch.Instance.cmbOutputDir.Items.Insert(k++, Properties.Settings.Default.OutputFolder5);
            }
        }
    }
}
