    ...
    class RecentFilesHelper
    {
        ...
        */
        ...
        public static void FillMenuRecentFile()
        {
            ...
            for (int k = 0; k < str.Length; k++)
            {
                frmBatch.Instance.tsdbAddFile.DropDownItems.Add(str[k]);                
            }
        }
        ...
        public static void FillRecentOutputFile()
        {
            ...
            for (int k = 0; k < str.Length; k++)
            {
                frmMain.Instance.cmbOutputFile.Items.Add(str[k]);
            }*/
        }
        ...
        public static void FillMenuRecentFolder()
        {
            ...
            for (int k = 0; k < str.Length; k++)
            {
                frmBatch.Instance.tsdbAddFolder.DropDownItems.Add(str[k]);
            }
        }
        ...
        public static void FillMenuRecentImportList()
        {
            ...
            for (int k = 0; k < str.Length; k++)
            {
                frmBatch.Instance.tsdbImportList.DropDownItems.Add(str[k]);
            }
        }
        ...
        public static void AddRecentFile(string filepath)
        {
            ...
            frmBatch.Instance.tsdbAddFile.DropDownItems.Clear();

            string newrec = "";

            for (int k = 0; k < strl.Count && k <= 12; k++)
            {
                frmBatch.Instance.tsdbAddFile.DropDownItems.Add(strl[k]);
                newrec += strl[k] + "|||";
            }
        ...
        public static void AddRecentOutputFile(string filepath)
        {
            ...
            frmMain.Instance.cmbOutputFile.Items.Clear();

            string newrec = "";

            for (int k = 0; k < strl.Count && k <= 12; k++)
            {
                frmMain.Instance.cmbOutputFile.Items.Add(strl[k]);
                newrec += strl[k] + "|||";
            }

            Properties.Settings.Default.RecentOutputFiles = newrec;

            frmMain.Instance.cmbOutputFile.SelectedIndex = 0;
             */
        }
        ...
        public static void ImportListRecent(string filepath)
        {
            ...
            frmBatch.Instance.tsdbImportList.DropDownItems.Clear();

            string newrec = "";

            for (int k = 0; k < strl.Count && k<=12; k++)
            {
                frmBatch.Instance.tsdbImportList.DropDownItems.Add(strl[k]);
                newrec += strl[k] + "|||";
            }
        ...
        public static void AddRecentFolder(string filepath)
        {
            ...
            frmBatch.Instance.tsdbAddFolder.DropDownItems.Clear();

            string newrec = "";

            for (int k = 0; k < strl.Count && k <= 12; k++)
            {
                frmBatch.Instance.tsdbAddFolder.DropDownItems.Add(strl[k]);
                newrec += strl[k] + "|||";
            }
