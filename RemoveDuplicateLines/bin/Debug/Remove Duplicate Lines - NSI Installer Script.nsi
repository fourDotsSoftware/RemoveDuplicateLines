...
;copy translations end
  ...
  !define MUI_FILE "RemoveDuplicateLines"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Remove Duplicate Lines"
  !define PRODUCT_SHORTCUT "Remove Duplicate Lines"
  !define PRODUCT_VERSION "1.4"
  
  !define MUI_ICON "text_align_justified.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  OutFile "RemoveDuplicateLinesSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Remove Duplicate Lines" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Remove Duplicate Lines - User's Manual.url.lnk" "$INSTDIR\Remove Duplicate Lines - User's Manual.url" "" "$INSTDIR\Remove Duplicate Lines - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Remove Duplicate Lines - User's Manual.chm";
  File "Remove Duplicate Lines - User's Manual.url";
  File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Remove Duplicate Lines" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Remove Duplicate Lines" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Remove Duplicate Lines"
  DeleteRegKey HKCU "Software\4dots Software\Remove Duplicate Lines"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/remove-duplicate-lines/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/remove-duplicate-lines/how-to-use.php?afterinstall=true"
FunctionEnd
