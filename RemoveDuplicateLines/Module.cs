...
namespace RemoveDuplicateLines
{
    class Module
    {
        ...
        public static string ApplicationName = "Remove Duplicate Lines";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/RemoveDuplicateLines/";
        public static string HelpURL = "https://www.4dots-software.com/remove-duplicate-lines/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/remove-duplicate-lines/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-remove-duplicate-lines.php";
        public static string VersionURL = "http://cssspritestool.com/versions/remove-duplicate-lines.txt";

        public static string TipText = TranslateHelper.Translate("Great application to remove duplicate lines from text !");
    ...
    "All Files (*.*)|*.*|Document Files (*.docx;*.txt;*.doc;*.rtf;)|*.docx;*.txt;*.doc;*.rtf";
